...
function generateDefaultTemplate(data) {
  ...
  // Customer info - only show if customer_id is provided
  const hasCustomer = invoice?.customer_id && (customer?.id || customer?.name);
...
<head>
  ...
  <style>
    * {
    ...
    /* Customer Section - Only visible when customer info exists */
    .customer-section {
      margin-bottom: 50px;
    }
...
<body>
  <div class="invoice-container">
    ...
    <!-- Customer Section - Only shown if customer_id is provided -->
    ${hasCustomer ? `
